  ...
  <div id="content">
    <div class="feature">
      <div class="searchform">
        <form id="pageComplexSearch" name="pageComplexSearch" action="${webRoot}/report/alert/complex/looking/mysql">
...
<script language="javascript" type="text/javascript">
	...
	$(document).ready(function(){ 
		...
		//加载监控主机列表
		loadMonitorsOptionSelected("${webRoot}","dbId",3,"${(formDto.dbId)}");
