function loadMemory(appRoot,dbId,beginTime,endTime,sqlId){
 	//加载主机
    var connects_options = {
        chart: {
            renderTo: 'sqlstat_memory', 
            type:'spline',
            zoomType: 'xy'
        },
         credits : {
    ...
    var connects_url =  appRoot+"/report/stat/oracle/sqlstat/data/memory/"+dbId+"/"+beginTime+"/"+endTime+"/"+sqlId;
