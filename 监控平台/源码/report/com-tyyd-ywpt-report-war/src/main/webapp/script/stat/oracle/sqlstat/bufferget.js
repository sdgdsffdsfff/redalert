function loadBufferGet(appRoot,dbId,beginTime,endTime,sqlId){
 	//加载主机
    var connects_options = {
        chart: {
            renderTo: 'sqlstat_buffer_get', 
            type:'spline',
            zoomType: 'xy'
        },
         credits : {
    ...
    var connects_url =  appRoot+"/report/stat/oracle/sqlstat/data/bufferget/"+dbId+"/"+beginTime+"/"+endTime+"/"+sqlId;
