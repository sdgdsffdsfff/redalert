function loadDiskRead(appRoot,dbId,beginTime,endTime,sqlId){
 	//加载主机
    var connects_options = {
        chart: {
            renderTo: 'sqlstat_disk_read', 
            type:'spline',
            zoomType: 'xy'
        },
         credits : {
    ...
    var connects_url =  appRoot+"/report/stat/oracle/sqlstat/data/diskread/"+dbId+"/"+beginTime+"/"+endTime+"/"+sqlId;
