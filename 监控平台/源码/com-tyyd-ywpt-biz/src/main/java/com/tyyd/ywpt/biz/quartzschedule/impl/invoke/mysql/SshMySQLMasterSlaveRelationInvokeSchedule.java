/**   
* @Title: SshMySQLMasterSlaveRelationInvokeSchedule.java 
* @Package com.tyyd.ywpt.biz.quartzschedule.impl.invoke.mysql 
* @Description:  
* @author wangyu   
* @date 2014-12-9 上午9:50:44 
* @CopyRight 天翼阅读
* @version V1.0   
*/
package com.tyyd.ywpt.biz.quartzschedule.impl.invoke.mysql;
...
public class SshMySQLMasterSlaveRelationInvokeSchedule extends AbstractQuotaScheduleQuartzTask{
	...
	public void doTask(QuartzScheduleJobBO scheduleJob) {
		...
		getMySQLSsh().sshRefreshMasterSlaveRelation(dbDomain.getDbId());
