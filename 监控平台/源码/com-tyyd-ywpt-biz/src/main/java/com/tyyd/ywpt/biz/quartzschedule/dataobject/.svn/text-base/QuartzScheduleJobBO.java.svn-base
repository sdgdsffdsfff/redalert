/**   
* @Title: QuartzScheduleJobBO.java 
* @Package com.tyyd.ywpt.biz.quartzschedule.dataobject 
* @Description:  
* @author wangyu   
* @date 2014-6-30 上午10:52:28 
* @CopyRight 天翼阅读
* @version V1.0   
*/
package com.tyyd.ywpt.biz.quartzschedule.dataobject;
 ...
 *
 */
public class QuartzScheduleJobBO {
	 ...
	 * @param desc
	 */
	public QuartzScheduleJobBO(String jobId, String beanId, String taskType,
