/**   
* @Title: MysqlQuotaTogetherDomain.java 
* @Package com.tyyd.ywpt.dao.core.collect.together.mysql.dataobject 
* @Description:  
* @author wangyu   
* @date 2014-6-16 下午2:43:22 
* @CopyRight 天翼阅读
* @version V1.0   
*/
package com.tyyd.ywpt.dao.core.collect.together.mysql.dataobject;
 ...
 *
 */
public class MysqlQuotaTogetherMonthDomain {
