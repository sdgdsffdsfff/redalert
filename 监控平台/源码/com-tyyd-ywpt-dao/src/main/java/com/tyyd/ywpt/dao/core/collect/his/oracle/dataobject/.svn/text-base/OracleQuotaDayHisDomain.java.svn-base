/**   
* @Title: OracleQuotaDayHisDomain.java 
* @Package com.tyyd.ywpt.dao.core.collect.his.oracle.dataobject 
* @Description:  
* @author wangyu   
* @date 2014-6-16 下午2:47:32 
* @CopyRight 天翼阅读
* @version V1.0   
*/
package com.tyyd.ywpt.dao.core.collect.his.oracle.dataobject;
 ...
 *
 */
public class OracleQuotaDayHisDomain {

	private String oracleQuotaHisId;
	...
	/**
	 * @return the oracleQuotaHisId
	 */
	public String getOracleQuotaHisId() {
		return oracleQuotaHisId;
	}

	/**
	 * @param oracleQuotaHisId the oracleQuotaHisId to set
	 */
	public void setOracleQuotaHisId(String oracleQuotaHisId) {
		this.oracleQuotaHisId = oracleQuotaHisId;
	}
