/**   
* @Title: OracleQuotaCollectDayDomain.java 
* @Package com.tyyd.ywpt.dao.core.collect.even.oracle.dataobject 
* @Description:  
* @author wangyu   
* @date 2014-6-16 下午2:45:10 
* @CopyRight 天翼阅读
* @version V1.0   
*/
package com.tyyd.ywpt.dao.core.collect.even.oracle.dataobject;
 ...
 *
 */
public class OracleQuotaCollectDayDomain {
