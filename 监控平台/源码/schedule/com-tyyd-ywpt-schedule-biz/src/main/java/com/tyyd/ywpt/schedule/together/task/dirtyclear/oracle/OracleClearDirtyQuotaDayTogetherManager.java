 ...
 *
 */
public class OracleClearDirtyQuotaDayTogetherManager extends AbstractClearDirtyQuotaTogetherManager{

	@Override
	public void clearQuotaDirtyData() {
		doTask(SysTypeEnum.Oracle.getVal(),TogetherStatTypeEnum.DAY.getVal());
	}
