/**   
* @Title: ServerTotalTypeBaseLineHandler.java 
* @Package com.tyyd.ywpt.schedule.baseline.handler.impl 
* @Description:  
* @author wangyu   
* @date 2015-3-10 下午6:55:16 
* @CopyRight 天翼阅读
* @version V1.0   
*/
package com.tyyd.ywpt.schedule.baseline.handler.impl;
 ...
 *
 */
public class ServerTotalTypeBaseLineHandler extends AbstractBaseLineHandler {

	@Resource
	private BaseLineMetaDataCalStrategyManager serverTotalTypeBaseLineMetaDataCalStrategy;
	...
	protected BaseLineMetaDataCalStrategyManager getCalStrategy() {
		return this.serverTotalTypeBaseLineMetaDataCalStrategy;
	}
