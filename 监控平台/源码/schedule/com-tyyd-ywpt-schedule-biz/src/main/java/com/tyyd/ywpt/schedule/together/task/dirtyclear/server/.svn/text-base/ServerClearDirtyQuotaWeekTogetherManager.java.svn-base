 ...
 *
 */
public class ServerClearDirtyQuotaWeekTogetherManager extends AbstractClearDirtyQuotaTogetherManager{

	@Override
	public void clearQuotaDirtyData() {
		doTask(SysTypeEnum.server.getVal(),TogetherStatTypeEnum.WEEK.getVal());
	}
