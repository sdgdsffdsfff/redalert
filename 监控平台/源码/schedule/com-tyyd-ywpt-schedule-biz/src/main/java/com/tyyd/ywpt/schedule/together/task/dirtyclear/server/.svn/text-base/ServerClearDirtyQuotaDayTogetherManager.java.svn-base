 ...
 *
 */
public class ServerClearDirtyQuotaDayTogetherManager extends AbstractClearDirtyQuotaTogetherManager{

	@Override
	public void clearQuotaDirtyData() {
		doTask(SysTypeEnum.server.getVal(),TogetherStatTypeEnum.DAY.getVal());
	}
