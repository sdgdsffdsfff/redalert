 ...
 *
 */
public class OracleClearDirtyQuotaWeekTogetherManager extends AbstractClearDirtyQuotaTogetherManager{

	@Override
	public void clearQuotaDirtyData() {
		doTask(SysTypeEnum.Oracle.getVal(),TogetherStatTypeEnum.WEEK.getVal());
	}
