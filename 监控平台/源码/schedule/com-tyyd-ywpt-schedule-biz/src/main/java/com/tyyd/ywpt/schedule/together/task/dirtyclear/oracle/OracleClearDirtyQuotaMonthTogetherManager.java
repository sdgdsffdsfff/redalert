...
* @version V1.0   
*/
package com.tyyd.ywpt.schedule.together.task.dirtyclear.oracle;
 ...
 *
 */
public class OracleClearDirtyQuotaMonthTogetherManager extends AbstractClearDirtyQuotaTogetherManager{

	@Override
	public void clearQuotaDirtyData() {
		doTask(SysTypeEnum.Oracle.getVal(),TogetherStatTypeEnum.MONTH.getVal());
	}
