...
* @version V1.0   
*/
package com.tyyd.ywpt.schedule.together.task.mysql;
 ...
 *
 */
public class MySQLQuotaMonthTogetherTask extends AbstractQuotaTogetherTask {

	@Override
	public void doQuotaTask() {
		doTask(SysTypeEnum.MySQL.getVal(),TogetherStatTypeEnum.MONTH.getVal());
	}
