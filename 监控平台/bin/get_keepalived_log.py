...
def open_alert_file(t_filename):
      ...
      for line in file_hand:
             ...
             info=[t_id,g_db_id,tmsg,is_completed,t_tmd5,g_gmt_create,g_gmt_modify,'0','21']
...
def usage():
    print '''
---------------usage:------------------
python get_keepalived_log_new.py -d dbid -f alert_file_path -k alert_key
or
python get_keepalived_log_new.py --dbid=dbid --alertfile=alert_file_path --alertkey=alert_key
---------------------------------------
'''
